...
DROP TABLE #tempPivot6A;
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/*
QUERY 6B: Order Fulfillment
...
Business Purpose:
This query will allow Back-to-Roots management to gain further insight into the information revealed by Query 6A, as they can filter by a specific date range. This will allow 
...
User Inputs:
1. @beginDate6B = 1/1/2018 AND @endDate6B = 12/31/2018 (2 rows)
2. @beginDate6B = 1/1/2019 AND @endDate6B = 12/31/2019 (3 rows)
3. @beginDate6B = 4/1/2020 AND @endDate6B = 5/31/2020 (1 row)
*/
DECLARE @beginDate6B DATE = '1/1/2019';
DECLARE @endDate6B DATE = '12/31/2019';
...
INNER JOIN PRODUCT
	ON Product.ProductID = OrderLine.ProductID
WHERE CustomerOrder.OrderDate BETWEEN @beginDate6B AND @endDate6B
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/*
QUERY 8B: Product Sales by Store Location
...
Business Purpose:
This query will allow Back-to-Roots management to gain further insight into the information revealed by Query 8A, as they can see which products have not been ordered at the Longmont location in 
...
User Inputs:
1. @beginDate8B = 1/1/2018 AND @endDate8B = 3/1/2021 (2 rows)
2. @beginDate8B = 11/1/2019 AND @endDate8B = 11/30/2019 (4 rows)
3. @beginDate8B = 4/1/2020 AND @endDate8B = 5/31/2020 (6 rows)
*/
DECLARE @beginDate8B DATE = '4/1/2020';
DECLARE @endDate8B DATE = '5/31/2020';
...
LEFT OUTER JOIN
	...
	WHERE 
		...
		AND CustomerOrder.OrderDate BETWEEN @beginDate8B AND @endDate8B) AS LongmontOrder
