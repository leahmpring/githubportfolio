...
IF EXISTS(
	SELECT *
	FROM sys.tables
	WHERE NAME = N'DimReward'
       )
	DROP TABLE DimReward
--
IF EXISTS(
	SELECT *
	FROM sys.tables
	WHERE NAME = N'DimPosition'
       )
	DROP TABLE DimPosition
--
-- Create tables
--
...
CREATE TABLE DimPosition
	(PositionSK				INT IDENTITY(1,1) NOT NULL CONSTRAINT pk_position_sk PRIMARY KEY,
	PositionAK				INT NOT NULL,
...
CREATE TABLE DimEmployee
	...
	CONSTRAINT fk_position FOREIGN KEY (PositionSK) REFERENCES DimPosition(PositionSK)
	);
--
CREATE TABLE DimReward
	(RewardSK				INT IDENTITY(1,1) NOT NULL CONSTRAINT pk_reward_sk PRIMARY KEY,
	RewardAK				NVARCHAR(4) NOT NULL,
...
CREATE TABLE DimCustomer
	...
	RewardSK				INT NOT NULL,
	CONSTRAINT fk_reward FOREIGN KEY (RewardSK) REFERENCES DimReward(RewardSK)
	);
--
